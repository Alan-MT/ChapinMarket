...
<h3 class="dashboard_logo" id="titulo">Chapin Market</h3>
    <h6 id="sucursal">Sucursal Sur</h6>
            <div class="dashboard_sidebar_user">
                <img src="/imagen/user.jpg" alt="User image"/>
                <span>Inventario Sur</span>
            </div>
            <div class="dashboard_sidebar_menus">
                <ul class="dashboard_menu_lists">
                    <li>
                        <a href="../Empleados-Surt/invetarioSur.php" id="opcion"><i class="fa fa-dashboard menuIcons"></i>Principal</a>
                    </li>
                    <li>
                        <a href="../Empleados-Surt/productoInventariosur.php" id="opcion1"><i class="fa fa-dashboard menuIcons"></i>Producto info.</a>
                    </li>
                </ul>
            </div>
        </div>
                ...
                <div class="section_content">
                    <div class="users">
                        <table>
                            ...
                            <tbody>
                                <?php
                                include('../controladores/invetario-productoSucuSur.php');
