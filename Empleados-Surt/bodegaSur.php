...
<h3 class="dashboard_logo" id="titulo">Chapin Market</h3>
    <h6 id="sucursal">Sucursal Sur</h6>
            <div class="dashboard_sidebar_user">
                ...
                <span>Bodega Sur</span>
            </div>
            <div class="dashboard_sidebar_menus">
                <ul class="dashboard_menu_lists">
                    <li>
                        <a href="../Empleados-Surt/bodegaSur.php" id="opcion"><i class="fa fa-dashboard menuIcons"></i>Principal</a>
                    </li>
                </ul>
            </div>
        </div>
            ...
            document.addEventListener('click', function(e) {
                ...
                if (classList.contains('Agregar')) {
                    ...
                    BootstrapDialog.confirm({
                        ...
                        <input type="text" class ="form-control" id="SC1" value="S2" disabled>\
                        </div>\
                        <div class="form-group">\
